...
| AtvBotaoAcaoInterna | deve renderizar o texto "Clique abaixo" | ✅ | ❌ | ReferenceError: View is not defined |
| AtvBotaoAcaoInterna | deve renderizar o Pressable com o texto "Clique aqui" | ✅ | ❌ | ReferenceError: View is not defined |
| AtvBotaoAcaoInterna | deve exibir um alerta com o texto "Fui clicado!" ao pressionar o botão | ✅ | ❌ | ReferenceError: View is not defined |
